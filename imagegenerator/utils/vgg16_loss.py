...
# from facegenerator.utils.hed.losses import sigmoid_cross_entropy_balanced
from facegenerator.utils.io_ops import IO
...
class Vgg16(object):
    ...
    def __init__(self, images):
        ...
        self.cfgs = {'optimizer': 'adam',
                     'batch_size_val': 10,
                     'download_path': '/home/soumya/Downloads',
                     'testing': {'image_height': 320,
                     ...
                     # 'training': {'image_height': 480,
                     #              'list': 'HED-BSDS/train_pair.lst',
                     #              'image_width': 480,
                     #              'dir': 'HED-BSDS',
                     #              'n_channels': 3},
                     'test_output': '/home/soumya/hed',
                     'test_snapshot': 5000,
                     'batch_size_train': 10,
